function [L, E] = calculateOptimalCutBraid(H, energyVecs, lambda, I, salMat, numIter)
...
%         disp(['Pertubation iteration ' num2str(numIter) 'New L Equal ? = ' num2str(flagEqual)]);
        [Lp, ~] = getEnergeticInf(Lnew, L, Enew, E);
